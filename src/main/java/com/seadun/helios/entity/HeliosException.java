...
public class HeliosException extends RuntimeException {
	...
	public HeliosException(String code, String description, Object content, HttpStatus httpStatus) {
	...
	public HeliosException(String code, String description, HttpStatus httpStatus) {
		log.info(">>>>>ConanException");
		log.info(">>>>>code:{}",code);
		log.info(">>>>>description:{}",description);
		log.info(">>>>>httpStatus:{}",httpStatus.toString());
