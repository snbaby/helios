package com.seadun.helios.interceptor;
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if(request.getMethod().equals("OPTIONS")) {//解决跨域OPTIONS 问题
			...
			if (userStr != null) {
				...
				_logger.info(">>>>>用户未登陆");
				throw new HeliosException(HeliosExceptionConstants.USER_NOT_LOGIN_EXCEPTION_CODE,
						HeliosExceptionConstants.USER_NOT_LOGIN_EXCEPTION_MESSAGE,
						HeliosExceptionConstants.USER_NOT_LOGIN_EXCEPTION_HTTP_STATUS);
			}
		}
	}
